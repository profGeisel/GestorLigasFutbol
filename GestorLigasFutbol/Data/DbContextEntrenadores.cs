...
namespace GestorLigasFutbol.Data
{
    public class DbContextEntrenadores : DbContext
    {
        ...
        public void CrearEntrenador(string nombre, string apellidoP, string apellidoM, DateTime fechaNacimiento, string correoE, string cedula, int idEquipo)
        {
            Database.ExecuteSqlRaw("exec spInsertarEntrenadores {0}, {1}, {2}, {3}, {4}, {5}, {6}", nombre, apellidoP, apellidoM,  fechaNacimiento, correoE, cedula, idEquipo);
        }

        //metodo para actualizar datos a la tabla
        public void ActualizarEntrenador(int id, string nombre, string apellidoP, string apellidoM,  DateTime fechaNacimiento, string correoE, string cedula, int idEquipo)
        {
            Database.ExecuteSqlRaw("exec spActualizarEntrenadores {0} ,{1}, {2}, {3}, {4}, {5}, {6}, {7}", id, nombre, apellidoP, apellidoM, fechaNacimiento, correoE, cedula, idEquipo);
        }
